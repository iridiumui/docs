    ...
    <header class="bg-grey-lightest flex items-center p-3">
        <div>
            <router-link to="/">
                ...
                <screen-lg>
                    <svg viewBox="0 0 274 68" xmlns="http://www.w3.org/2000/svg">
