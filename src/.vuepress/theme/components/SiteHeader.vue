            ...
            <div class="lg:w-64 lg:pl-12 xl:w-80">
                <router-link to="/">
                    ...
                    <ir-screen-sm direction="down">
                        <svg aria-hidden class="h-8" viewBox="0 0 68 68" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ir-screen-md>
                        <svg aria-hidden class="h-8" viewBox="0 0 274 68" xmlns="http://www.w3.org/2000/svg">
                ...
                <ir-hamburger-nav>
                    <div slot-scope="{ toggle, open }">
                        <button  @click="toggle">
                            ...
                            <svg aria-hidden class="text-grey-darker" fill="currentColor" viewBox="0 0 29 22" width="29" height="22" xmlns="http://www.w3.org/2000/svg"><g><rect width="29" height="4" rx="2"/><rect y="9" width="29" height="4" rx="2"/><rect y="18" width="29" height="4" rx="2"/></g></svg>
                        </button>
